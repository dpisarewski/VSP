...
public class Proxy {
    ...
    public static synchronized Map<String, Object> invoke(String hostname, int port, String name, String methodName, Object object, boolean returnValue) throws Exception {
        ...
        if (returnValue){
            ...
            connection.sendAndClose(Marshalling.encodeInvoke(name, methodName, object));
            return null;
        }
